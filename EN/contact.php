...
if(!empty($_POST)) {
  extract($_POST);
  $valid = true;
  if(empty($nom)){  $valid=false; $erreurnom="Mandatory name ";}
  if(empty($prenom)){ $valid=false; $erreurprenom="Mandatory Firstname";}
  if(!preg_match("/^[a-z0-9\-_.]+@[a-z0-9\-_.]+\.[a-z]{2,3}$/i",$email))
   {
    $valid=false;
    $erreurmail ="Your email is not valid";
   }
  if(empty($email)){  $valid=false; $erreurmail="Mandatory email";}
  if(empty($phone)){  $valid=false; $erreurphone="Mandatory phone";}
  if(empty($texte)){  $valid=false; $erreurtexte="Mandatory message"; }
  if($valid){ 
      ...
      <section class="header">
        <div class="row">
          ...
          <div class="col-md-3 drapeau">
                  ...
                  <a href="contact.php"><img class="drapeau" src="../style/image/icon/en.gif" alt="EN"></a>
         </div>
        </div>
              ...
              <div class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="contact.php">Contact / Access</a></li>
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-lg-6 gauche">
            <strong>To access « Parenthèse Champêtre » :</strong>
                  <p>GPS Coordinates : N50° 39.7284', E002° 39.2408'</p>
              ...
              <form class="form-horizontal" role="form" action="contact.php" method="post">
                <strong>Contactez-nous par le formulaire:</strong>
                    ...
                    <label for="Nom" class="col-sm-2 control-label">Name</label>
                      <div class="col-sm-7">
                        <input type="text"  class="form-control" id="Nom" name="nom" placeholder="Name" value="<?php if(isset($nom)) echo $nom; ?>">
                        <span id="error-message"><?php if(isset($erreurnom)) echo $erreurnom; ?></span>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="Prenom" class="col-sm-2 control-label">Firstname</label>
                        <div class="col-sm-7">
                          <input type="text"  class="form-control" id="Prenom" name="prenom" placeholder="Firstname" value="<?php if(isset($prenom)) echo $prenom; ?>">
                    ...
                    <div class="form-group">
                      <label for="email" class="col-sm-2 control-label">Phone</label>
                        <div class="col-sm-7">
                          <input type="tel"  class="form-control" id="telephone" name="phone" placeholder="Phone" value="<?php if(isset($phone)) echo $phone; ?>">
          ...
          <div class="col-lg-6">
                <iframe  height="350"   src="https://maps.google.fr/maps?f=q&amp;source=s_q&amp;hl=fr&amp;geocode=&amp;q=4+rue+du+Moulin+59940+NEUF+BERQUIN&amp;aq=&amp;sll=50.529025,3.160487&amp;sspn=2.042828,5.410767&amp;ie=UTF8&amp;hq=&amp;hnear=4+Rue+du+Moulin,+59940+Neuf-Berquin&amp;ll=50.662186,2.652565&amp;spn=1.02096,2.705383&amp;t=h&amp;z=9&amp;output=embed"></iframe>           
          </div>
        </div> 
